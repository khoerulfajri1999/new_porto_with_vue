...
<template>
  <div 
    ...
    <div class="flex flex-col mt-70 sm:mt-0 sm:flex-row items-center gap-10 md:gap-70 relative z-10">
  <!-- Tombol Kiri (Technical Skills) -->
  <div ref="circleBtnLeft" class="relative z-20 cursor-pointer group duration-1000 animate-float">
    <!-- Tombol utama teknis -->
    ...
    <button
      ...
      :style="`transform: translate(${index * 60}px, ${index * 60}px);`"
    >
      <div class="flex items-center justify-center w-full h-full">
        <component :is="icon" class="w-4 h-4 md:w-6 md:h-6 text-cyan-400 group-hover/sub:text-white transition-colors duration-300" />
      </div>
  ...
  <!-- Tombol Kanan (Soft Skills) -->
  <div ref="circleBtnRight" class="relative z-10 cursor-pointer group duration-1000 animate-float opacity-0" style="animation-delay: 0.5s">
    <!-- Tombol utama soft skill -->
    <div class="relative bg-gradient-to-r from-emerald-500 via-green-500 to-teal-600 rounded-full p-1 shadow-2xl hover:shadow-emerald-500/25 transition-all duration-300 hover:scale-110">
      <div class="bg-slate-900 rounded-full p-3 px-1 md:p-6 relative overflow-hidden">
        ...
        <div class="relative flex flex-col items-center gap-2 text-white">
          <Users class="w-5 h-5 md:w-8 md:h-8 text-emerald-400 group-hover:text-emerald-300 transition-colors duration-300" :class="{ 'animate-bounce': isVisibleRight }" />
          <span class="font-bold text-[0.7rem] md:text-sm tracking-wide w-20 text-center">SOFT<br>SKILLS</span>
        </div>
    ...
    <button
      ...
      :style="`transform: translate(${index * 70}px, ${index * 70}px);`"
    >
      <div class="flex items-center justify-center w-full h-full">
        <component :is="icon" class="w-7 h-7 text-emerald-400 group-hover/sub:text-white transition-colors duration-300" />
      </div>
      <div class="absolute inset-0წ
