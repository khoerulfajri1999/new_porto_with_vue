    ...
    <div class="flex-1 mt-30 w-full relative z-10">
      ...
      <div ref="buttonGroupRef" class="flex flex-col sm:flex-row items-start sm:items-center gap-6 mb-8 opacity-0">
        ...
        <div class="relative group">
          ...
          class="flex items-center cursor-pointer gap-3  bg-transparent border-2 border-slate-600 rounded-xl text-slate-300 font-semibold hover:border-emerald-500 hover:text-emerald-400 transition-all duration-300 group-hover:scale-105">
