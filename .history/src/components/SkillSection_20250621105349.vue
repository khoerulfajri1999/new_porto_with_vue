...
<template>
  <div 
    ...
    <!-- Function counter -->
    <div ref="counterRef" class="absolute bottom-1 left-1/2 transform -translate-x-1/2 text-center opacity-0">
    ...
    <div ref="legendRef" class="absolute top-195 sm:top-3/5 left-8 transform -translate-y-1/2 opacity-0">
      <div class="hidden sm:block bg-slate-800/80 text-xs sm:text-[0.9rem] backdrop-blur-sm border border-cyan-500/30 rounded-lg p-4 max-w-sm hover:scale-105 transition-transform duration-300">
        ...
        <div class="text-md text-slate-300 space-y-2">
          ...
          <div class="flex items-center gap-2 hover:text-green-400 transition-colors duration-200">
            ...
            <span>Backend: Node.js, Express.js, Laravel, Go, Spring Boot, Django</span>
          </div>
