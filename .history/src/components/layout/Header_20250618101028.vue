      ...
      <div class="flex flex-col items-center justify-between w-full max-w-full">
        ...
        >
          ...
          >
            ...
            <div class="relative">
              <span
                class="relative inline-flex items-center justify-center py-4 px-4 text-xl sm:text-3xl lg:text-5xl font-bold text-transparent bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text transition-all duration-200 rounded-xl hover:scale-105 group"
                :class="{
          ...
          >
            ...
            <div
              class="flex items-center justify-between gap-6 px-3 py-3 sm:px-6 sm:py-3 transition-opacity duration-500 relative z-10"
              :class="{
            ...
            >
              ...
              >
                <Menu class="w-5 h-5 sm:w-6 sm:h-6 text-cyan-400 group-hover:text-white transition-colors duration-300" />
