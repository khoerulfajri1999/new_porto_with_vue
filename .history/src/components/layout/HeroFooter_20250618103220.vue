<template>
  <div class="flex items-center justify-center relative min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-black">
    ...
    <div class="relative">
      ...
      >
        ...
        <!-- Status Indicator -->
        <div class="absolute -bottom-10 left-1/2 transform -translate-x-1/2 flex items-center gap-2 px-3 py-1.5 bg-slate-900/80 border border-cyan-400/30 rounded-full backdrop-blur-md opacity-0 transition-all duration-300 group-hover:opacity-100 group-hover:-translate-y-1">
          <div class="w-1.5 h-1.5 bg-emerald-400 rounded-full animate-pulse"></div>
          <span class="text-[10px] text-cyan-400 font-semibold tracking-wider">READY</span>
        </div>
      </div>
    </div>
  </div>
