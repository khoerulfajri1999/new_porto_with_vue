          ...
          >
            ...
            >
              <a
                href="#"
                title="Get quote now"
                class="relative inline-flex items-center justify-center py-4 text-3xl lg:text-5xl font-bold text-transparent bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text transition-all duration-200 rounded-xl hover:scale-105 group"
              >
                <!-- Glowing text effect -->
                <span class="relative">
                  KHOERUL FAJRI
