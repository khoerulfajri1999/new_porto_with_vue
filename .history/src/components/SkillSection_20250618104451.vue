...
<template>
  <div 
    ...
    <div class="flex items-center gap-70 relative z-10">
      ...
      >
        <div class="relative bg-gradient-to-r from-cyan-500 via-blue-500 to-blue-600 rounded-full p-1 shadow-2xl hover:shadow-cyan-500/25 transition-all duration-300 hover:scale-110">
          <div class="bg-slate-900 rounded-full p-6 relative overflow-hidden">
            <!-- Animated background -->
            ...
            <div class="relative flex flex-col items-center gap-2 text-white">
              <Code2 class="w-8 h-8 text-cyan-400 group-hover:text-cyan-300 transition-colors duration-300" :class="{ 'animate-spin': isVisibleLeft }" />
              <span class="font-bold text-sm tracking-wide text-center">TECHNICAL<br>SKILLS</span>
            </div>
        ...
        <button
          ...
          class="absolute bottom-8 left-8 w-14 h-14 rounded-full bg-gradient-to-r from-slate-800 to-slate-700 hover:from-cyan-600 hover:to-blue-600 shadow-lg border border-cyan-500/30 hover:border-cyan-400 transform translate-x-0 translate-y-0 transition-all duration-300 hover:scale-110 group/sub z-10"
          :title="buttonLabelsLeft[index]"
        >
          <div class="flex items-center justify-center w-full h-full">
            <component 
              :is="icon" 
              class="w-6 h-6 text-cyan-400 group-hover/sub:text-white transition-colors duration-300" 
            />
          </div>
      ...
      <div
        ref="circleBtnRight"
        class="relative z-20 cursor-pointer group duration-1000 animate-float opacity-0"
      ...
      >
        <div class="relative bg-gradient-to-r from-emerald-500 via-green-500 to-teal-600 rounded-full p-1 shadow-2xl hover:shadow-emerald-500/25 transition-all duration-300 hover:scale-110">
          <div class="bg-slate-900 rounded-full p-6 relative overflow-hidden">
            ...
            <div class="relative flex flex-col items-center gap-2 text-white">
              <Users class="w-8 h-8 text-emerald-400 group-hover:text-emerald-300 transition-colors duration-300" :class="{ 'animate-bounce': isVisibleRight }" />
              <span class="font-bold text-sm tracking-wide w-20 text-center">SOFT<br>SKILLS</span>
            </div>
    ...
    <!-- Title -->
    <div ref="titleRef" class="absolute top-16 left-1/2  transform -translate-x-1/2 text-center max-w-4xl opacity-0">
      <h1 class="m:text-5xl text-4xl md:text-6xl lg:text-7xl font-bold bg-gradient-to-r from-cyan-400 via-blue-400 to-emerald-400 bg-clip-text text-transparent relative">
        About Me.
    ...
    <div ref="legendRef" class="absolute top-1/2 left-8 transform -translate-y-1/2 opacity-0">
      <div class="bg-slate-800/80 backdrop-blur-sm border border-cyan-500/30 rounded-lg p-4 max-w-sm hover:scale-105 transition-transform duration-300">
