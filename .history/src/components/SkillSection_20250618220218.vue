...
<template>
  <div 
    ...
    <div class=" flex flex-col mt-80 sm:mt-0 sm:flex-row items-center gap-15 md:gap-10 lg:gap-70 relative z-10">
      ...
      >
        ...
        <button
          ...
          class="absolute bottom-7 left-7  md:bottom-8 md:left-8 w-9 h-9 md:w-11 md:h-11 lg:w-14 lg:h-14 rounded-full bg-gradient-to-r from-slate-800 to-slate-700 hover:from-cyan-600 hover:to-blue-600 shadow-lg border border-cyan-500/30 hover:border-cyan-400 transform translate-x-0 translate-y-0 transition-all duration-300 hover:scale-110 group/sub"
          :title="buttonLabelsLeft[index]"
        >
          <div class="flex items-center justify-center w-full h-full">
            <component 
              :is="icon" 
              class="w-4 h-4 md:w-5 md:h-5 lg:w-6 lg:h-6 text-cyan-400 group-hover/sub:text-white transition-colors duration-300" 
            />
          </div>
        ...
        <div class="relative bg-gradient-to-r from-emerald-500 via-green-500 to-teal-600 rounded-full p-1 shadow-2xl hover:shadow-emerald-500/25 transition-all duration-300 hover:scale-110">
          <div class="bg-slate-900 rounded-full p-3 md:p-6 relative overflow-hidden">
            ...
            <div class="relative flex flex-col items-center gap-2 text-white">
              ...
              <span class="font-bold text-[0.7rem] md:text-[0.73rem] lg:text-sm tracking-wide w-16 md:w-18 lg:w-20 text-center">SOFT<br>SKILLS</span>
            </div>
    ...
    <div ref="counterRef" class="absolute bottom-16 left-1/2 transform -translate-x-1/2 text-center opacity-0">
      <div class="flex flex-rpw gap-6">
        <div class="bg-slate-800/60 w-full backdrop-blur-sm border border-cyan-500/30 rounded-lg px-6 py-3 hover:bg-slate-700/60 transition-colors duration-300 hover:scale-105">
          <span class="text-cyan-400 text-xs md:text-sm font-medium">
        ...
        <div class="bg-slate-800/60 backdrop-blur-sm border border-emerald-500/30 rounded-lg px-6 py-3 hover:bg-slate-700/60 transition-colors duration-300 hover:scale-105">
          <span class="text-emerald-400 text-xs md:text-sm  font-medium">
    ...
    <div ref="legendRef" class="absolute top-195 sm:top-1/2 left-8 transform -translate-y-1/2 opacity-0">
      <div class="hidden bg-slate-800/80 text-xs sm:text-[0.9rem] backdrop-blur-sm border border-cyan-500/30 rounded-lg p-4 max-w-sm hover:scale-105 transition-transform duration-300">
