    ...
    <div class="flex flex-col mt-70 sm:mt-0 sm:flex-row items-center gap-10 md:gap-70 relative z-10">
      ...
      >
        ...
        <button
          ...
          class="absolute bottom-8 left-8 w-10 h-14 rounded-full bg-gradient-to-r from-slate-800 to-slate-700 hover:from-cyan-600 hover:to-blue-600 shadow-lg border border-cyan-500/30 hover:border-cyan-400 transform translate-x-0 translate-y-0 transition-all duration-300 hover:scale-110 group/sub z-10"
