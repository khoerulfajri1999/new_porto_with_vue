<template>
  <section
    ...
    <div class="flex-1 mt-30 w-full relative z-10">
      ...
      <h1
        ref="headingRef"
        class="text-center text-4xl md:text-6xl lg:text-7xl font-bold mb-8 leading-tight opacity-0">
        <div class="mb-4">
          <div class="flex flex-row items-center justify-center">
            <span class="text-white mr-4 block">I am a</span>
            <div class="flex items-center gap-4">
              <span ref="typedElement" class="text-transparent bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600  font-black"></span>
