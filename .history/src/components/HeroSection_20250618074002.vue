<template>
  <section
    class="container px-6 sm:px-0 relative z-10 flex-1 flex flex-col lg:flex-row justify-between items-center mx-auto "
    ref="mainRef"
    id="home">
    ...
    <!-- Content Section -->
    <div class="flex-1 mt-10 md:mt-16 lg:mt-30 xl:mt-25 relative z-10">
      <!-- Status Indicator -->
      <div ref="statusRef" class="flex items-center gap-3 mb-6 opacity-0">
        <div class="flex items-center gap-2 px-4 py-2 bg-slate-900/50 backdrop-blur-sm border border-blue-500/30 rounded-full">
          <Cpu class="w-4 h-4 text-blue-400 animate-spin" />
          <span class="text-blue-400 text-sm font-medium">I'M READY</span>
        </div>
      </div>
      ...
      <h1
        ref="headingRef"
        class="text-4xl md:text-6xl lg:text-7xl font-bold mb-8 leading-tight opacity-0">
        <div class="mb-4">
          <div class="flex flex-row">
            ...
            <div class="flex items-center gap-4">
              ...
              <div class="w-1 h-12 md:h-16 lg:h-20 bg-gradient-to-b from-cyan-400 to-blue-600 animate-pulse"></div>
            </div>
          </div>
      ...
      <div
        ...
        <div class="relative bg-slate-900/30 backdrop-blur-sm border border-slate-700/50 rounded-xl p-6 w-[50vw]">
          <div class="flex items-center gap-2 mb-4">
            <Terminal class="w-5 h-5 text-cyan-400" />
            <span class="text-cyan-400 text-sm font-mono">PROFILE.EXE</span>
          </div>
          <p class="text-slate-300 text-base lg:text-lg leading-relaxed font-light">
          ...
          <div class="mt-4 flex flex-wrap gap-2">
            <span v-for="tech in ['React.js', 'Vue.js', 'Next.js', 'Laravel', 'Node.js', 'Spring Boot', 'React Native']" 
                  :key="tech"
                  class="px-3 py-1 bg-slate-800/50 border border-cyan-500/30 rounded-full text-xs text-cyan-400 font-mono">
              {{ tech }}
            </span>
          </div>
        </div>
