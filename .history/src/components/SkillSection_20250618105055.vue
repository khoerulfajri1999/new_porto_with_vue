...
<template>
  <div 
    ref="mainContainer"
    class="container mx-auto flex items-center justify-center min-h-[90vh] relative bg-gradient-to-br from-[#030415] via-[#1E0B38] to-[#030415] overflow-hidden"
    id="about"
    >
    ...
    <!-- Title -->
    <div ref="titleRef" class="absolute top-16 left-1/2  transform -translate-x-1/2 text-center w-full opacity-0">
