    ...
    <div class="flex-1 mt-30 w-full relative z-10">
      ...
      <div ref="buttonGroupRef" class="flex flex-col sm:flex-row items-start sm:items-center gap-6 mb-8 opacity-0">
        ...
        <div class="relative group">
          ...
          <a href="#contact" class="relative cursor-pointer flex items-center gap-3 px-8 py-7 bg-slate-900 border border-cyan-500/50 rounded-xl text-white font-semibold hover:bg-slate-800 transition-all duration-300 group-hover:scale-105">
