...
<template>
  <div 
    ...
    <div ref="legendRef" class="absolute top-195 sm:top-1/2 left-8 transform -translate-y-1/2 opacity-0">
      <div class="hidden sm:visi bg-slate-800/80 text-xs sm:text-[0.9rem] backdrop-blur-sm border border-cyan-500/30 rounded-lg p-4 max-w-sm hover:scale-105 transition-transform duration-300">
