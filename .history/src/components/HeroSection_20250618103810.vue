  ...
  <section
    ...
    <div class="flex-shrink-0 mt-22 lg:mt-0 lg:mr-12">
      <div ref="imageGroupRef" class="relative opacity-0">
        ...
        <div class="relative lg:flex w-64 h-64 sm:w-80 sm:h-80 lg:w-96 lg:h-96 rounded-full overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 border-4 border-transparent bg-clip-padding">
          <!-- Gradient Border -->
