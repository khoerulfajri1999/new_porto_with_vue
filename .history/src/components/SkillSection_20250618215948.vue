  ...
  <div 
    ...
    <div ref="counterRef" class="absolute bottom-16 left-1/2 transform -translate-x-1/2 text-center opacity-0">
      <div class="flex gap-6">
        <div class="bg-slate-800/60 w-20 backdrop-blur-sm border border-cyan-500/30 rounded-lg px-6 py-3 hover:bg-slate-700/60 transition-colors duration-300 hover:scale-105">
