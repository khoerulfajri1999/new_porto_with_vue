      ...
      <div ref="socialRef" class="flex items-center gap-6 opacity-0">
        ...
        <div class="flex gap-4">
          <button
            ...
            <div class="absolute inset-0 bg-gradient-to-r p-7 from-cyan-500/20 to-blue-500/20 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
          </button>
        </div>
      </div>
    </div>
