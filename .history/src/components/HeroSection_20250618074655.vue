<template>
  <section
    class="container px-0 sm:px-0 relative z-10 flex-1 flex flex-col lg:flex-row justify-between items-center mx-auto "
    ref="mainRef"
    id="home">
    ...
    <!-- Content Section -->
    <div class="flex-1 mt-30 w0full relative z-10">
      <!-- Status Indicator -->
