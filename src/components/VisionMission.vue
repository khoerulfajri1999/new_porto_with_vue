  ...
  <section class="grid grid-cols-1 md:grid-cols-8">
    ...
    >
      ...
      <p class="text-sm leading-relaxed">
        To become a trusted technology partner that drives sustainable digital
        transformation in Indonesia through innovative, adaptive, and impactful
        software solutions.
      </p>
    </div>
    ...
    >
      ...
      <ul class="text-sm leading-relaxed list-disc pl-4 space-y-2">
        <li>
          Create impactful digital solutions that are tailored, user-friendly,
          and delivered with high quality and precision.
        </li>
        <li>
          Collaborate transparently with clients to build strong partnerships
          and deliver meaningful results.
        </li>
        <li>
          Empower local talent while fostering a culture of innovation,
