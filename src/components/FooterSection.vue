<template>
    <footer
      ref="footerRef"
      class="relative z-10 bg-gray-900 text-white pt-12 pb-6 opacity-0 translate-y-10"
    >
      <div class="max-w-7xl mx-14 px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          <h2 class="text-2xl font-bold mb-4">stevara.id</h2>
          <p class="text-gray-400 text-sm">A trusted digital solution for your events and business.</p>
        </div>
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li><a href="#home" class="hover:text-gray-300">Contact</a></li>
          </ul>
        </div>
        <div>
          <h3 class="text-xl font-semibold mb-4">Contact</h3>
          <ul class="space-y-2 text-gray-400 text-sm">
            <li><i class="fas fa-map-marker-alt mr-2"></i>Purwokerto, Central Java, Indonesia</li>
            <li><i class="fas fa-phone mr-2"></i>+62 812-3456-7890</li>
            <li><i class="fas fa-envelope mr-2"></i>info@stevara.id</li>
          </ul>
        </div>
        <div class="flex flex-col">
          <h3 class="text-xl font-semibold">Follow Us</h3>
          <div
            class="flex flex-col space-y-4 px-3 py-4 w-fit"
          >
            <button
