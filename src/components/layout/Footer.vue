<template>
  <div class="bg-neutral-800">
    <footer
      ref="footerRef"
      class="container px-10 sm:px-0 mx-auto relative z-10 bg-neutral-800 text-white pt-12 pb-6 opacity-0 translate-y-10"
    >
      <div
        class="max-w-full grid grid-cols-1 md:grid-cols-5 gap-8"
      >
        ...
        <div>
          ...
          <ul class="space-y-2 text-gray-400 text-sm">
            <li>
              <i class="fas fa-map-marker-alt mr-2"></i>Purwokerto, Central Java,
              Indonesia
            </li>
